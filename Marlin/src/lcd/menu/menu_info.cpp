...
//
  ...
  void menu_info_printer() {
    ...
    #endif
    #ifdef MAPLE_STM32F1
      STATIC_ITEM_F(F("Maple STM32F1 HAL"), SS_CENTER);
    #elif defined(HAL_STM32)
      STATIC_ITEM_F(F("Common STM32 HAL"), SS_CENTER);
    #endif
    END_SCREEN();
  }
